...
define('CVS_REVISION', '$RCSfile$ - $Revision: 101040 $');
...
if ($_POST['do'] == 'updatepermissions')
{
	...
	$categoryinfo = $assertor->getRow('vBForum:imagecategory', array(
		...
		vB_Db_Query::COLUMNS_KEY => array('imagetype'),
	));
	...
	$assertor->assertQuery('vBForum:imagecategorypermission', array(
