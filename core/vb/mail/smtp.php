...
class vB_Mail_Smtp extends vB_Mail
{
	...
	*/
	public function __construct()
	{
		...
		$this->clientHost = vB_String::parseUrl($vboptions['bburl'], PHP_URL_HOST);
	...
	*/
	private function sendMessage($msg, $expectedResult = false)
	{
	...
	*/
	...
	private function sendHello()
	{
		...
		if (!$this->sendMessage('EHLO ' . $this->clientHost, 250))
		{
			if (!$this->sendMessage('HELO ' . $this->clientHost, 250))
			{
				return false;
			}
		}
