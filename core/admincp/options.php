...
define('CVS_REVISION', '$RCSfile$ - $Revision: 100771 $');
...
if ($_REQUEST['do'] == 'editsetting' OR $_REQUEST['do'] == 'addsetting')
{
	...
	{
		$setting = vB::getDbAssertor()->getRow('setting', array('varname' => $vbulletin->GPC['varname']));
	...
	else
	{
		$ordercheck = vB::getDbAssertor()->getRow('setting',
			array('grouptitle' => $vbulletin->GPC['grouptitle']),
			array('field' => 'displayorder', 'direction' => vB_dB_Query::SORT_DESC)
		);
