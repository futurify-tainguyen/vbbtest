...
class vB_Upgrade_370b2 extends vB_Upgrade_Version
{
	...
	*/
	function step_88()
	{
		...
		// Similar to above. followforummoderation was removed in VBV-7734.
		if (!isset($this->registry->bf_ugp_forumpermissions['followforummoderation']))
		{
			$this->registry->bf_ugp_forumpermissions['followforummoderation'] = 131072;
		}
		$this->run_query(
	...
	*/
	...
	function step_94()
	{
	 	...
	 	//styles that exist at this point are incompatible with vb5.  And we don't
		//even use YUI anymore.  This also will attempt to compile old style
